...
//int32 SET_SPEED_FACTOR = 10    #use arg speed_factor to change time scale of trajectory plan; larger than 1.0--> slower
    ...
    int knock_left(int object_id,geometry_msgs::PoseStamped object_pose_stamped);   
    int knock_right(int object_id,geometry_msgs::PoseStamped object_pose_stamped);  
    int straddle_block(int object_id,geometry_msgs::PoseStamped object_pose_stamped);  
