...
int main(int argc, char** argv) {
    ...
    ROS_INFO("knock it off!");
    g_goal_done = false;
    goal.action_code = coordinator::ManipTaskGoal::GRAB_OBJECT;
    
    //let's knock the sucker off
    g_object_pose.pose.position.x = g_object_pose.pose.position.x - 0.75;
      g_object_pose.pose.position.x = g_object_pose.pose.position.y + 0.75;
